...
![Version: 4.6.0-0](https://img.shields.io/badge/Version-4.6.0--0-informational?style=flat-square) ![AppVersion: 4.6.0](https://img.shields.io/badge/AppVersion-4.6.0-informational?style=flat-square)
...
| wso2.gatewayAPI.enabled | bool | `false` | Enable Gateway API resources (alternative to Ingress) |
| wso2.gatewayAPI.createGateway | bool | `true` | Create a Gateway resource (set to false if using a shared/external Gateway) |
| wso2.gatewayAPI.gatewayClassName | string | `"envoy"` | GatewayClass name (must exist in cluster, e.g., "envoy" for Envoy Gateway). |
| wso2.gatewayAPI.gatewayName | string | `"envoy"` | Name of the Gateway resource |
| wso2.gatewayAPI.gatewayNamespace | string | `"envoy-gateway"` | Namespace of the Gateway resource |
| wso2.gatewayAPI.tlsSecret | string | `""` | K8s TLS secret for configured hostname (for Gateway API) |
| wso2.gatewayAPI.ratelimit.enabled | bool | `false` | Enable Gateway API rate limiting (default: false) |
| wso2.gatewayAPI.ratelimit.requestsPerSecond | int | `10` | Requests per second limit |
| wso2.gatewayAPI.ratelimit.burst | int | `5` | Burst limit for rate limiting |
| wso2.gatewayAPI.backendTLS.enabled | bool | `false` | Enable backend TLS policy (default: false) |
